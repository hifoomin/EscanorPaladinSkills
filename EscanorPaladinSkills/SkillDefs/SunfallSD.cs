...
namespace EscanorPaladinSkills.SkillDefs
{
    public class SunfallSD : SkillDefBase<SunfallSD>
    {
        ...
        public override string DescriptionText => "<style=cIsDamage>Fleeting</style>. <style=cDeath>Stun yourself</style> and call down your hand, summoning <style=cIsDamage>20</style> meteors for <style=cIsDamage>350% damage</style> each.";
        ...
        public override Sprite Icon => Main.escanor.LoadAsset<Sprite>("texSunfall.png");
